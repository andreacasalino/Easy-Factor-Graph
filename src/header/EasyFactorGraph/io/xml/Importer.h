...
//         static std::map<std::string, std::size_t> importFromXml(Model& model,
//         const FilePath& filePath) {
//             return Importer().importComponents(filePath.getPath(),
//             filePath.getFileName(), getComponents(model));
//         };

//     private:
//         std::map<std::string, std::size_t> importComponents(const
