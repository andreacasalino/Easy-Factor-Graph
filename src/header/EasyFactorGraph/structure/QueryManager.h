...
public:
  ...
  getJointMarginalDistribution(const std::array<std::size_t, N> &vars) {
    ...
    return factor::FactorT<N, factor::NullTrasform>::fromCompactDomain(
        vars_sizes, buffer);
  }
