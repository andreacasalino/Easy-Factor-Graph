...
//     public:
//         inline const
//         std::set<std::shared_ptr<distribution::factor::cnst::Factor>>&
//         getConstFactors() const { return this->factorsConst; }; inline const
//         std::set<std::shared_ptr<distribution::factor::cnst::FactorExponential>>&
//         getConstFactorsExp() const { return this->factorsConstExp; };

//         inline const std::set<EFG::distribution::DistributionCnstPtr>&
//         getAllFactors() const { return this->factorsAll; };
