...
//     StructureTunableAware::getFactorsExp() const {
//         std::vector<std::vector<std::shared_ptr<distribution::factor::modif::FactorExponential>>>
//         result; result.resize(this->numberOfClusters); for (auto it =
//         this->factorsExp.begin(); it != this->factorsExp.end(); ++it) {
...
//         for (auto it = this->factorsExp.begin(); it !=
//         this->factorsExp.end(); ++it) {
