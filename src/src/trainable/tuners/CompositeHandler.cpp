...
//     CompositeHandler::CompositeHandler(TrainHandlerPtr elementA,
//     TrainHandlerPtr elementB) {
//         this->elements.emplace_back(std::move(elementA));
//         this->elements.emplace_back(std::move(elementB));
//     }

//     void CompositeHandler::setTrainSet(TrainSetPtr newSet, const
