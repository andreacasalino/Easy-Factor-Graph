...
namespace EFG::train {
    /**
     * @brief refer to <a href="linkURL">https://en.wikipedia.org/wiki/Nonlinear_conjugate_gradient_method</a> and the possible strategies to compute beta
     */
    class BetaStrategy
    ...
    /**
     * @brief At every iteration the minimum along the direction of the conjugate gradient method, <a href="linkURL">https://en.wikipedia.org/wiki/Nonlinear_conjugate_gradient_method</a> , is searched
     */
