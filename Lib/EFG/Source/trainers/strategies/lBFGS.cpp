...
//
//namespace EFG::train {
//    void LBFGS::updateInvHessian(const Eigen::VectorXf& deltaW, const Eigen::VectorXf& deltaGrad) {
//        {
...
//            this->invHessianApprox = this->pastIterations.back().V.transpose() * this->invHessianApprox * this->pastIterations.back().V;
//            this->invHessianApprox += (1.f / this->pastIterations.back().rho) * deltaW * deltaW.transpose();
//        }
//        else {
//            throw 0; //todo
//        }
