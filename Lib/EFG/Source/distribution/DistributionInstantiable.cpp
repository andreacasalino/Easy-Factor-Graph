...
namespace EFG::distribution {
    DistributionInstantiable::DistributionInstantiable(const std::set<categoric::VariablePtr>& group, EvaluatorPtr evaluator) {
        this->group = std::make_unique<categoric::Group>(group);
        this->values = std::make_shared<std::map<categoric::Combination, float>>();
    ...
    DistributionInstantiable::DistributionInstantiable(const DistributionInstantiable& o) {
        ...
        this->values = std::make_shared<std::map<categoric::Combination, float>>(*o.values);
    ...
    DistributionInstantiable& DistributionInstantiable::operator=(DistributionInstantiable&& o) {
        *this->group = *o.group;
        this->values = o.values;
        o.values = std::make_shared<std::map<categoric::Combination, float>>();
        return *this;
    }
