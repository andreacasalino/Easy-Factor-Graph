...
\includegraphics[width=\columnwidth]{../Chapter_additional/04_Samples/image_01/Ternary_corr.eps}
\end{minipage} 
 & 
\begin{minipage}[t]{0.48 \columnwidth}
\includegraphics[width=\columnwidth]{../Chapter_additional/04_Samples/image_01/Ternary_anitcorr.eps}
\end{minipage} 
\end{tabular}
