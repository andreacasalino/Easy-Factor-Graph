...
\begin{figure}
	\centering
	\includegraphics[width= 0.49 \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_00.png}
...
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_01.png}
\end{minipage}
 &
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_02.png}
\end{minipage}
\end{tabular}
...
\begin{tabular}{ll}
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_03.png}
\end{minipage}
 &
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_04.png}
\end{minipage}
\end{tabular}
...
\begin{figure}
	\centering
	\includegraphics[width= 0.49 \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_05.png}
...
\begin{figure}
	\centering
	\includegraphics[width= 0.49 \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_06.png}
...
\begin{tabular}{ll}
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_07.png}
\end{minipage}
 &
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_08.png}
\end{minipage}
\end{tabular}
...
\begin{tabular}{ll}
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_09.png}
\end{minipage}
 &
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_10.png}
\end{minipage}
\end{tabular}
...
\begin{tabular}{ll}
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_11.png}
\end{minipage}
 &
\begin{minipage}[t]{0.49\textwidth}
	\includegraphics[width= \columnwidth]{../Chapter_additional/05_EFG_GUI/image/img_12.png}
\end{minipage}
\end{tabular}
