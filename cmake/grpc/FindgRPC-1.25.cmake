...
if(GRPC_LIBRARY AND NOT TARGET gRPC::grpc)
  ...
  set_target_properties(gRPC::grpc PROPERTIES
    ...
    INTERFACE_LINK_LIBRARIES "${WSOCK32_LIBRARY};${WS2_LIBRARY};${CRYPTO32_LIBRARY};OpenSSL::SSL;OpenSSL::Crypto;ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;gRPC::gpr"
  )
endif()
...
if(GRPC_GRPC_UNSECURE_LIBRARY AND NOT TARGET gRPC::grpc_unsecure)
  ...
  set_target_properties(gRPC::grpc_unsecure PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES ${GRPC_INCLUDE_DIR}
    INTERFACE_LINK_LIBRARIES "${WSOCK32_LIBRARY};${WS2_LIBRARY};${CRYPTO32_LIBRARY};ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;gRPC::gpr"
...
if(GRPC_GRPC++_LIBRARY AND NOT TARGET gRPC::grpc++)
  ...
  set_target_properties(gRPC::grpc++ PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES ${GRPC_INCLUDE_DIR}
    INTERFACE_LINK_LIBRARIES "${WSOCK32_LIBRARY};${WS2_LIBRARY};${CRYPTO32_LIBRARY};OpenSSL::SSL;OpenSSL::Crypto;protobuf::libprotobuf;gRPC::grpc;gRPC::gpr"
...
if(GRPC_GRPC++_ALTS_LIBRARY AND NOT TARGET gRPC::grpc++_alts)
  ...
  set_target_properties(gRPC::grpc++_alts PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES ${GRPC_INCLUDE_DIR}
    INTERFACE_LINK_LIBRARIES "${WSOCK32_LIBRARY};${WS2_LIBRARY};${CRYPTO32_LIBRARY};OpenSSL::SSL;OpenSSL::Crypto;protobuf::libprotobuf;gRPC::gpr;gRPC::grpc_cronet;gRPC::grpc"
...
if(GRPC_GRPC++_UNSECURE_LIBRARY AND NOT TARGET gRPC::grpc++_unsecure)
  ...
  set_target_properties(gRPC::grpc++_unsecure PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES ${GRPC_INCLUDE_DIR}
    INTERFACE_LINK_LIBRARIES "${WSOCK32_LIBRARY};${WS2_LIBRARY};${CRYPTO32_LIBRARY};protobuf::libprotobuf;gRPC::gpr;gRPC::grpc_unsecure"
