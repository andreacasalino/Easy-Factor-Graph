...
namespace EFG::sample {
    ...
    std::vector<Combination> TrainSetCreator::getSamples(const std::vector<std::size_t>& evidences, std::size_t numberOfSamples, std::size_t deltaIteration) {
