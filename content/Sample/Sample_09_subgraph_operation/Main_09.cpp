...
//build the graph
	...
	graph.Gibbs_Sampling_on_Hidden_set(&sample, 100, 200);
...
// compute the marginal probabilities of the follwoing two combinations (values refer to varaibles in the subgraph, i.e. A1, 2, 3, 4)
	...
	cout << Get_empirical_frequencies(sample, sub_A_1234_combinations.front(), Var_A1234, Entire_Hidden_set) << endl;
	cout << "														                           computed  ";
	cout << marginal_probs.front() << endl;

	cout << "Prob(A1=1, A2=1, A3=0,A4=0 | X1=0,X2=0) empirical   ";
	cout << Get_empirical_frequencies(sample, sub_A_1234_combinations.back(), Var_A1234, Entire_Hidden_set) << endl;
	cout << "														                            computed  ";
	cout << marginal_probs.back() << endl;
...
//build the subgraph involving {B1,2,3}
	...
	cout << Get_empirical_frequencies(sample, sub_B_123_combinations.front(), Var_B123, Entire_Hidden_set) << endl;
	cout << "														             computed  ";
	cout << marginal_probs.front() << endl;

	cout << "Prob(B1=1, B2=1, B3=0 | X1=0,X2=0) empirical   ";
	cout << Get_empirical_frequencies(sample, sub_B_123_combinations.back(), Var_B123, Entire_Hidden_set) << endl;
	cout << "														              computed  ";
	cout << marginal_probs.back() << endl;
